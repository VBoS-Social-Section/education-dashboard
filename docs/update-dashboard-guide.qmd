...
![Add file dropdown menu.](images/step3-add-file-menu.png){width=80%}
...
![Creating a new file to make the year folder](images/step3-create-year-folder.png){width=80%}
...
![Upload files button](images/step4-upload-button.png){width=80%}
![Upload files screen with drag-and-drop area](images/step4-upload-pdf.png){width=80%}
...
![GitHub Actions tab showing a successful workflow run](images/step5-actions.png){width=80%}
